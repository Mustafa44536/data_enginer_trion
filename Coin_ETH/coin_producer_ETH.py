...
from common.connect_api import get_latest_coin_data, fetch_exchange_rates
import sys

sys.path.append(r"/Users/apple/Data_Platform/github/Project_Group10/streaming_crypto_group_10")
